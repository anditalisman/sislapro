...
if(isset($_POST['submit'])){
	...
	$tahap=htmlentities($_POST['tahap']);
  	
	$query=mysql_query("insert into data_kavling values('','$nomor_kavling','$tahap','$type')");
...
<tr>
    ...
    <div id="content-table-inner">
              ...
              <td><!--  start step-holder -->
                <!--  end step-holder -->
                  ...
                  <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                    <tr>
                      <th valign="top">Nomor kavling </th>
                      <td><input type="text" class="inp-form" name="nomor_kavling"/></td>
                      <td></td>
                    </tr>
                    <tr>
        ...
        <tr>
            ...
            <th width="13%" class="table-header-repeat line-left minwidth-1"><a href="">Tahap</a></th>
            <th width="11%" class="table-header-repeat line-left minwidth-1"><a href="">Type</a></th>
            <th width="5%" class="table-header-options line-left"><a href="">Aksi</a></th>
        </tr>
        
        
        <?php
		$view=mysql_query("select * from data_kavling order by nomor_kavling asc");
