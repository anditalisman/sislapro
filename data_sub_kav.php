...
if(isset($_POST['submit'])){
	...
	$query=mysql_query("insert into tabel_sub_kav values('','$id_subkon','$id_kavling')");
	
	if($query){
		?><script language="javascript">document.location.href="?page=data_sub_kav&status=1";</script><?php
	}else{
		?><script language="javascript">document.location.href="?page=data_sub_kav&status=2";</script><?php
	}
...
<tr>
    ...
    <div id="content-table-inner">
    		...
    		<form action="?page=data_sub_kav" method="post">
 	        <table border="0" width="100%" cellpadding="0" cellspacing="0">
            <tr valign="top">
                ...
                <!--  end step-holder -->
                  ...
                  <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                    <tr>
					  ...
					  while($row1=mysql_fetch_array($subkon)){
					  ?>
                          <option value="<?php echo $row1['id_subkon'];?>"><?php echo $row1['nama_subkon'];?></option>
					  <?php
					  }
					  ?>                          
		    ...
		    <p><em>*Satu Subkon mengelola banyak kavling      	    </em>
              <!--  start product-table ..................................................................................... -->
        </p>
		    <p>&nbsp;    </p>
        ...
        <?php
		$view=mysql_query("select * from tabel_sub_kav sub_kav, data_kavling kavling, data_subkon subkon where sub_kav.id_kavling=kavling.id_kavling and sub_kav.id_subkon=subkon.id_subkon order by id_sub_kav asc");
